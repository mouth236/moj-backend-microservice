...
import com.mouth.mojbackendquestionservice.mapper.QuetionMapper;
...
/**
* @author Lenovo
* @description 针对表【quetion(题目表)】的数据库操作Service实现
* @createDate 2023-11-17 22:03:55
*/
@Service
public class QuestionServiceImpl extends ServiceImpl<QuetionMapper, Question> implements QuestionService {
